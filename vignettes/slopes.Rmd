...
A marginal effect measures the association between a change in a regressor $x$, and a change in the response $y$. Put differently, the marginal effect is the slope of the prediction function, measured at a specific value of the regressor $x$.
